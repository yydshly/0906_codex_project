...
export class Input {
  ...
  constructor(camera:THREE.PerspectiveCamera,canvas:HTMLCanvasElement,
    ...
    c.minDistance=.135;c.maxDistance=.42;c.minPolarAngle=.22;c.maxPolarAngle=1.35;
  ...
  private begin=(e:PointerEvent)=>{
    ...
    this.body.grab=grab;this.body.wake();this.canvas.dispatchEvent(new CustomEvent('companion-grab',{detail:{height:point.y-this.body.center.y}}));
  ...
  private finishRelease=()=>{
    if(this.body.grab)this.canvas.dispatchEvent(new Event('companion-release'));
